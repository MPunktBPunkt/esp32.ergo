...
Stand dieser Datei: **2026-09-13** Arbeit an **0.3.16-dev**
(Bridge Resistance-Takeover / manuelle Gänge).
...
| Aktuelle Bin | `dist/ergo.0.3.16-dev.esp32s3.bin` |
...
ERG Stufen-Slew 0.3.15; Bridge Resistance-Takeover 0.3.16.
