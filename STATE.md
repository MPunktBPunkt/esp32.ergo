...
Stand dieser Datei: **2026-09-13** Arbeit an **0.3.15-dev**
(ERG Stufen-Slew / Retarget-Hysterese).
...
| Aktuelle Bin | `dist/ergo.0.3.15-dev.esp32s3.bin` |
