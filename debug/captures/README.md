...
|-------|-------------------|----------|---------|
| `nachtest-20260913T085205Z.jsonl` | `HW_NACHTEST_20260913.md` | 0.3.x-dev | Primärbeleg im Repo (~536 kB) |
| `nachtest-20260913T145717Z.jsonl` | Nachtest-Abend | 0.3.x-dev | lokal ~12 MB, **nicht** im Git (Größe) |
| `nachtest-live.jsonl` | laufender/letzter Mitschnitt | — | Arbeitsdatei, nicht kanonisch |
